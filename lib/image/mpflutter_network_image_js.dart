...
@immutable
class MPFlutterNetworkImage
    extends image_provider.ImageProvider<image_provider.NetworkImage>
    implements image_provider.NetworkImage {
  /// Creates an object that fetches the image at the given URL.
  MPFlutterNetworkImage(String url, {this.scale = 1.0, this.headers})
      : this.url = useNativeCodec(url);
  ...
  @override
  Future<MPFlutterNetworkImage> obtainKey(
      image_provider.ImageConfiguration configuration) {
    return SynchronousFuture<MPFlutterNetworkImage>(this);
  }
  ...
  Future<ui.Codec> _loadAsync(
    ...
    if (isCanvasKit || containsNetworkImageHeaders) {
      ...
      chunkEvents.add(
          ImageChunkEvent(cumulativeBytesLoaded: 0, expectedTotalBytes: 4));
